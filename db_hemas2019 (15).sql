...
INSERT INTO `tbl_ad_booking` (`ad_book_id`, `cus_id`, `newsad_mode_id`, `adcolour_name`, `newsp_id`, `newsac_category`, `adcattype_desc`, `admode_details_size`, `crnt_date`, `adpub_date`, `ad_description`, `ad_wc`, `ad_tot_price`, `ad_img`, `ad_img_nic`, `ad_img_br`, `ad_img_slip`, `ad_pay_status`, `ad_book_status`) VALUES
(1, 1, 0, 'Black & White', 'Sunday T', 'Automobile', 'For Sale', '4cmx1cm', '2021-04-20', '2021-04-30', 'Car for sale', 3, 1500.00, '', '', '', '', 1, 0),
(2, 1, 0, 'Black & White', 'Sunday T', 'Automobile', 'For Sale', '4cmx1cm', '2021-04-20', '2021-04-30', 'go go go', 3, 1500.00, '', '', '', '', 1, 0),
(3, 3, 0, 'Black & White', 'Sunday T', 'Automobile', 'For Sale', '4cmx1cm', '2021-04-20', '2021-04-23', 'go go go', 3, 1500.00, '', '', '', '', 1, 0),
(4, 12, 4, 'CL002', 'NEWP0001', 'ACAT0004', 'ADCT0166', '3', '2021-04-20', '2021-06-17', 'Height 5\'8\", Age 28, Working as a government officer with a good salary. Call 0334567891 in afternoon.', 18, 1992.38, '', 'images/upload_image/nic_image/ACAT0004_2021-06-171618939245.jpg', '', '4.jpg', 0, 0),
(5, 12, 5, 'CL001', 'NEWP0001', 'ACAT0005', 'ADCT0169', '3', '2021-04-21', '2021-06-27', '', 0, 0.00, 'images/upload_image/add_book_image/ACAT0005_2021-06-271618954872.png', 'images/upload_image/nic_image/ACAT0005_2021-06-271618954872.jpg', 'images/upload_image/brc_image/ACAT0005_2021-06-271618954872.jpg', '', 0, 0),
(6, 12, 5, 'CL001', 'NEWP0001', 'ACAT0005', 'ADCT0169', '3', '2021-04-21', '2021-06-27', '', 0, 0.00, 'images/upload_image/add_book_image/ACAT0005_2021-06-271618954882.png', 'images/upload_image/nic_image/ACAT0005_2021-06-271618954882.jpg', 'images/upload_image/brc_image/ACAT0005_2021-06-271618954882.jpg', '', 0, 0),
(7, 12, 5, 'CL001', 'NEWP0001', 'ACAT0005', 'ADCT0169', '3', '2021-04-21', '2021-06-27', '', 0, 0.00, 'images/upload_image/add_book_image/ACAT0005_2021-06-271618954890.png', 'images/upload_image/nic_image/ACAT0005_2021-06-271618954890.jpg', 'images/upload_image/brc_image/ACAT0005_2021-06-271618954890.jpg', '', 0, 0),
(8, 12, 4, 'CL001', 'NEWP0001', 'ACAT0004', 'ADCT0166', '1', '2021-04-21', '2021-06-20', 'Height 5\'8\", Age 28, Working as a government officer with a good salary. Call 0334567891 in afternoon.', 18, 1811.25, '', 'images/upload_image/nic_image/ACAT0004_2021-06-201618964920.jpg', '', '', 1, 1),
(9, 12, 1, 'CL001', 'NEWP0002', 'ACAT0004', 'ADCT0166', '1', '2021-04-21', '2021-06-20', 'Height 5\'8\", Age 28, Working as a government officer with a good salary. Call 0334567891 in afternoon.', 18, 1811.25, '', 'images/upload_image/nic_image/ACAT0004_2021-06-201618965276.jpg', '', '', 0, 0),
(10, 12, 1, 'CL001', 'NEWP0001', 'ACAT0004', 'ADCT0166', '1', '2021-04-21', '2021-06-27', 'Height 5\'8\", Age 28, Working as a government officer with a good salary. Call 0334567891 in afternoon.', 18, 1811.25, '', 'images/upload_image/nic_image/ACAT0004_2021-06-271618965696.jpg', '', '', 0, 0);
...
('INV20210421_0002', 3, '2021-04-21', 1, 0.00, 80.00, 80.00, 0, '', 'offline', 1);
...
--
ALTER TABLE `tbl_ad_order`
  MODIFY `adorder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Constraints for table `tbl_np_booking_pay`
--
ALTER TABLE `tbl_np_booking_pay`
  ADD CONSTRAINT `tbl_np_booking_pay_ibfk_1` FOREIGN KEY (`inv_id`) REFERENCES `db_bitproject2019`.`tbl_invoice` (`inv_id`) ON DELETE CASCADE ON UPDATE CASCADE;
