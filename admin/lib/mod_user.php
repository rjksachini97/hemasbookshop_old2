...
/*
Following function returns all the employees who don not have a system login
*/
...
function addNewUser(){
	...
	$utype = $_POST["cmbtype"];
	$pwd = md5($eid);//encrypt the password using MD5 assign to variable
	$status = 1;
	$reset =1;
...
function updateUsers(){
	...
	$sql = "UPDATE tbl_users SET usr_type=?, usr_status=? WHERE usr_name=? "; 
