  ...
  $(function(){
    ...
    $("#btnreg").click(function(){
      ...
      if(!doj.match(date_pattern)){
        swal("Invalid Input", "Please enter a valid date of joined", "error");
        return;
      }
      ...
      var url = "lib/mod_seller.php?type=addNewSeller";
          ...
          <!-- New employee form-->
            <form>
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="txtsellerid" name="txtsellerid" value="<?php echo($newid); ?>" readonly="readonly">
                </div>
              </div>
