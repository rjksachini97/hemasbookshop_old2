...
<div class="card mt-3" >
	...
	<p class="text-center text-primary">This will provide summury of Low Newspaper Quantity</p>
	<div class="d-flex justify-content-between">
      <div class="col-lg-4">
...
$(document).ready(function(){
    var dataTable = $("#ls_report").DataTable({
        ...
        "dom": 'Bfrtip',
        "ajax":{
            "url":"lib/mod_reports.php?type=lowStockSummary",
            "type":"POST",
        },
        "columns":[
            {"data":"0"},
    ...
    $("#btn-export").click(function(){
    	...
    	window.open('view/reports/lowStockSummaryReportPDF.php?category='+category,'_blank');
