...
$output .="<h3 class='text-center'>Online Newspaper Order Analysis Report By Date</h3>";
...
$sql = "SELECT * From tbl_invoice inv JOIN tbl_reg_customer cus ON inv.cus_id = cus.cus_id WHERE inv_type ='online' AND inv_date BETWEEN '$sdate' AND '$edate' AND inv_total > '$income' ORDER BY inv_id ";
...
$output .="<table class='table small' >
    ...
    $sql2 = "SELECT * From tbl_invoice inv JOIN tbl_reg_customer cus ON inv.cus_id = cus.cus_id WHERE inv_type ='online' AND inv_date BETWEEN '$sdate' AND '$edate' AND inv_total > '$income' ORDER BY inv_id ";
