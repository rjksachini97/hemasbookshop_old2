...
<div class="card mt-3" >
	<h4 class="text-center h4 font-weight-bold text-primary">Newspaper Order Summary Report By Month </h4>
 ...
 <div class="m-3">
        ...
        <?php 
           ...
           $sql_data = "SELECT * FROM tbl_invoice inv JOIN tbl_reg_customer cus ON inv.cus_id = cus.cus_id WHERE MONTH(inv_date)='$month' AND YEAR(inv_date)='$year'  ";
